$(document).ready(function() {
    ...
    a.buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)"), $(".dataTables_length select").addClass("form-select form-select-sm"), $("#tb_computer").DataTable({
        select: {
            style: "multi"
        },
        language: {
